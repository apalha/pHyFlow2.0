...
// the cpu fmm version
boost::python::tuple fmm2d_py_cpu(pyublas::numpy_vector<double> xBlob, pyublas::numpy_vector<double> yBlob, pyublas::numpy_vector<double> wBlob,
...
void initfmm2d_py_cpu() {;}

#ifdef CUDASUPPORT
void initfmm2d_py_gpu() {;}
#endif
...
BOOST_PYTHON_MODULE(_fmm2d_py)
{
    boost::python::def("fmm2d_py_cpu", fmm2d_py_cpu, boost::python::args("xBlob","yBlob","wBlob","xTarget","yTarget","Ndirect","xopt","cutoff","tol"), fmm2d_py_cpu_docs);
    #ifdef CUDASUPPORT
    boost::python::def("fmm2d_py_gpu", fmm2d_py_gpu, boost::python::args("xBlob","yBlob","wBlob","xTarget","yTarget","Ndirect","xopt","cutoff","tol"), fmm2d_py_cpu_docs);
    #endif
}
