...
#include "vv2par_device.cu"

/*--------------- Python callable function defintions -------------------*/
extern "C" static PyObject *vv2par_gpu(PyObject *self, PyObject *args);
extern "C" void init_vv2par_gpu();
...
static PyMethodDef _vv2par_gpu[] = {
   {"vv2par_gpu", vv2par_gpu, METH_VARARGS,vv2par_gpu_docs},
   {NULL} /*Sentiner - marks the end of this Python structure*/
};

/*--------------Initialize the vv2par functions -------------------------*/
void init_vv2par_gpu(){
   (void) Py_InitModule("_vv2par_gpu", _vv2par_gpu);
   import_array(); /* Must be present for Numpy */
}

/*-------------------- Python wrapping function - HOST -----------------------*/
static PyObject *vv2par_gpu(PyObject *self, PyObject *args){
// Python wrapping function, pass data between Python and C and call CUDA Host Code.
  ...
  cvy = (double*)vy->data;
    ...
    // return the Python array with induced velocities
