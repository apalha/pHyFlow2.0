...
# Mark no-slip
noslip = NoSlip()
noslip.mark(boundaryDomains, pHyFlow.navierStokes.nsOptions.ID_NOSLIP_BOUNDARY) # No-slip ID: 2

# Mark exterior I.D
lid = Lid()
lid.mark(boundaryDomains, pHyFlow.navierStokes.nsOptions.ID_EXTERNAL_BOUNDARY) # extID : 3  
